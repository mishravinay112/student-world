...
<tr>
    ...
    <input name="username" type="text"  size="20"  placeholder="User Name" /><span id="user_id"  style="color:#F00" ; ></span>
    </td>
</tr>
...
<tr>   
    ...
    <td width="100" align="center"> <input name="userpassword" type="password"   placeholder="" size="20" />
    <br/>  <span id="password_id"  style="color:#F00" font size="3" ; > </span> </td>
    </tr>
<tr>   
	<td width="100" height="30">Confirm passward:<br/></td>
    <td width="100" align="center"> <input name="confirmpassword" type="password"   placeholder="" size="20" />
...
<tr>
    ...
    <td width="100" align="center">
    <input name="useremail" type="text"   size="20"  placeholder="Email-id">
    <span id="email_id" style="color:#F00" ; > </span> <br/>
    </td>
</tr>
<tr>
      <td width="100">Mobile number:<br/></td>
      <td width="100" align="center"><input name="mobileno"  type="text"  size="21">
       <span id="mobile_id" style="color:#F00" ; > </span></td>
</tr>
<tr>
      <td width="100">College:<br/></td>
      <td width="100" align="center"><input name="college"  type="text"  size="21">
       <span id="mobile_id" style="color:#F00" ; > </span></td>
</tr>
<tr>
 <td width="20" align="">State :</td>
 <td align="center"><select style="width:43%;height:30%;" name="state" id="state"   required="required"      onchange="javascript: dropdownlist2(this.options[this.selectedIndex].value);">
 ...
 document.write('<select style="width:43%;height:30%;" name="city" id="city" required="required" onchange="javascript: dropdownlist3(this.options[this.selectedIndex].value);"><option value="">Select city</option></select>')
 </script>
 ...
 <tr>
    ...
    <input name="area" type="text"  size="21"  placeholder="Area" />
    </td>
</tr>
<tr>
	<td width="100">address :<br/></td>
    <td width="100" align="center"><textarea name="address"   style="width:150px" cols="25" id="addr" placeholder="Address"></textarea>
    </td>
</tr>
<tr>
	<td col width="200" height="30">Pin code:<br/></td>
    <td width="200" align="center">
    <input name="pincode" type="text"  size="21"  placeholder="Pin-code" />
    <span id="pincode_id" style="color:#F00" ; > </span></td>
</tr>
    <tr>
      <td height="100" width="100" colspan="2" align="center" > <input class="ss" type="submit"  value="submit">     </tr>
