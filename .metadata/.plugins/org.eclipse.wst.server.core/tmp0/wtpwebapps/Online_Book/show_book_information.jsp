...
<form id="formname" name="formname"  action="buy_controller"  method="get"  enctype="multipart/form-data">
 ...
 <tr style="height: 300%">
      <td ><p>Course :</p></td>
      <td><div>
          <select  style="width:80%;height:20%;" size="1"  name="category" id="category"      onChange="javascript: dropdownlist(this.options[this.selectedIndex].value);"   required="required">
 ...
 document.write('<select style="width:80%;height:20%;" size="1" name="subcategory" id="subcategory" required="required" onchange="javascript: dropdownlist1(this.options[this.selectedIndex].value);"><option value="">......select stream.....</option></select>')
      ...
      <td><div>
          <script type="text/javascript" language="JavaScript">
 document.write('<select style="width:80%;height:20%;" size="1" name="subcategory1"><option value="">......select subject.....</option></select>')
  </script>
          <noscript>
  ...
  <td><div>State : </div></td>
 <td><div><select style="width:80%;height:20%;" name="state" id="state"   required="required"      onchange="javascript: dropdownlist4(this.options[this.selectedIndex].value);">
 ...
 <td><div><script type="text/javascript" language="JavaScript">
 document.write('<select style="width:80%;height:20%;" name="city" id="city" required="required" onchange="javascript: dropdownlist3(this.options[this.selectedIndex].value);"><option value="">Select city</option></select>')
 </script>
...
<td><a href="view_all_book_information.jsp?email=<%=s.getEmail()%>&id=<%=s.getAuto()%>"><img src="file1/< %=s1%>" width="150" height="150" id="" /></a>
</br><a href="view_all_book_information.jsp?email=<%=s.getEmail()%>&id=<%=s.getAuto()%>">Book Name::<%=s.getBook_name()%></a>
</br><a href="view_all_book_information.jsp?email=<%=s.getEmail()%>&id=<%=s.getAuto()%>">Price Rs.<%=s.getPrice()%></a></td><td width="30"></td>
