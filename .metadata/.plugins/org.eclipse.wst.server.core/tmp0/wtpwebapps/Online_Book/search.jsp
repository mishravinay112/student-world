...
<form id="formname" name="formname"  action="buy_controller"   method="get"  enctype="multipart/form-data">
 <table border="0" width="40%" height="50%" align="center" >
 <tr>
 ...
 <tr>
  <td align="right" valign="middle"><div align="left">State : </div></td>
 <td align="left" valign="middle"><div align="center"><select style="width:40%;height:10%;" name="state" id="state"   required="required"      onchange="javascript: dropdownlist4(this.options[this.selectedIndex].value);">
 ...
 <tr> <td align="right" valign="middle"><div align="left">City : </div></td>

 <td align="left" valign="middle"><div align="center"><script type="text/javascript" language="JavaScript">
 document.write('<select style="width:40%;height:10%;" name="city" id="city" required="required" onchange="javascript: dropdownlist3(this.options[this.selectedIndex].value);"><option value="">Select city</option></select>')
 </script>
