...
<form id="formname" name="formname"  action="SaleControler" onSubmit="return validateForm()"  method="post"  enctype="multipart/form-data">
 ...
 <tr>
      <td width="21%" align="right" valign="middle"><p align="left">Course :</p></td>
      <td width="79%" align="left" valign="middle"><div align="center">
          <select  style="width:40%;height:10%;" size="1"  name="category" id="category"      onChange="javascript: dropdownlist(this.options[this.selectedIndex].value);"   required="required">
    ...
    <tr>
      <td align="right" valign="middle"><div align="left">Stream : </div></td>
      <td align="left" valign="middle"><div align="center">
          <script type="text/javascript" language="JavaScript">
 document.write('<select style="width:40%;height:10%;" size="1" name="subcategory" id="subcategory" required="required" onchange="javascript: dropdownlist1(this.options[this.selectedIndex].value);"><option value="">......select stream.....</option></select>')
    ...
    <tr>
      <td align="right" valign="middle"><div align="left">Subject : </div></td>
      <td align="left" valign="middle"><div align="center">
          <script type="text/javascript" language="JavaScript">
 document.write('<select style="width:40%;height:10%;" size="1" name="subcategory1"><option value="">......select subject.....</option></select>')
  </script>
          <noscript>
    ...
    <tr>
      <td width="21%" align="right" valign="middle"><div align="left">Writer Name:</div></td>
      <td width="35%"  ><div align="center">
          <input  style="padding-right: 2" "text" name="Writer_Name" required="required" >
          <span id="w_id"></span></div></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle"><div align="left">Edition:</div></td>
      <td ><div align="center">
          <input width="35" type="text" name="Edition_Name" required="required" >
          <span id="e_id"></span></div></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle" ><div align="left">Book Name:</div></td>
      <td ><div align="center">
          <input width="35" type="text" name="Book_Name" required="required">
          <span id="b_id"></span></div></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle"><div align="left">Price:</div></td>
      <td ><div align="center">
          <input width="35" type="text" name="Prise" required="required" >
          <span id="priceid"></span> </div></td>
    </tr>
    <tr>
      <td width="31%" align="" >Book Description:</td>
      <td width="35"><div align="center">
          <textarea name="book_description" cols="15" rows="8" required="required" ></textarea>
          <span id="d_id"></span></div></td>
    </tr>
    <tr>
      <td width="21%" align="left">Negotiable status:</td>
    ...
    <td ><input type="file" name="image" onChange="previewImage(this)" accept="image/*" required="required" /></td>
      ...
      <td   width="21%" height="150" align="right" valign="middle"><div  align="center"><img name="preview" width="140"  height="140" id="preview" alt="upload book photo" /> </div>
         </tr>
    <tr>
